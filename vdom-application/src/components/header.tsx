...
export function Header({ appName, userLogin, navList }: Props) {
  ...
  const dataProvider = new ArrayDataProvider(navList, { keyAttributes: "path" });
    ...
    <header role="banner" class="oj-web-applayout-header">
      <div class="oj-web-applayout-max-width oj-flex-bar oj-sm-align-items-center">
        ...
        <oj-toolbar>
          ...
          <oj-navigation-list edge="top" data={dataProvider}></oj-navigation-list>
        </oj-toolbar>
        </div>
      </div>
    </header>
